...
${OBJECTDIR}/Hints.o: Hints.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Hints.o Hints.cpp

${OBJECTDIR}/UsrInpt.o: UsrInpt.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UsrInpt.o UsrInpt.cpp
