...
void switchH(char color[],char pick[],bool hintR,char hint,int nTrys,int &limit){ 
    do{
        cout<< "*******************************\n\n"<<"Hints: "<<endl;
        cout<<" 1: Display colors that are correct and in the  right spot."<<endl;
        cout<<" 2: Display colors are correct but not in correct spot."<<endl;
